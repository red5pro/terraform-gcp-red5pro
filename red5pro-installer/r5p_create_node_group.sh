...
create_jwT_token() {
    ...
    for i in {1..5}; do
        JWT_TOKEN_JSON=$(curl --insecure -s -m 10 -X 'PUT' "$SM_URL/as/v1/auth/login" -H 'accept: application/json' -H "Authorization: Basic $USER_AND_PASSWORD_IN_BASE64" -H "Content-Length: 0")
